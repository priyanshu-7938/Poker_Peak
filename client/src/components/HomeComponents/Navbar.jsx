                ...
                <div className="flex mx-2 gap-4">
                    <div className="flex gap-1 items-center">
                        ...
                        <div className="flex flex-col">
                            <p className="text-1xl bg-[#979797] rounded-[10px] p-1 flex truncate w-[100px] justify-between">₹ {userData?.userInfo?.pooledMoney}<p className="cursor-pointer" onClick={()=>{Navigate("addmoney")}}>➕</p></p>
                        </div>
                    </div>
                    <div className="flex gap-1 items-center">
                    ...
                    <ConnectWallet 
                        ...
                        theme="light"
                    />
                    <div className="flex items-center gap-1 cursor-pointer" onClick={()=>setUserData(null)}>
                        <img src={logout} className="h-[70%]" alt="" />Logout
                    </div> 
                </div>
